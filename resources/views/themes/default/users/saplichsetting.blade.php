        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Cài đặt ca mặc định</h3>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($data as $item)
                            <tr>
                                ...
                                <td><input type="checkbox" name="parttimedaluu[{{$item->id}}]" @if($item->parttime == 1) checked @endif /></td>
                            </tr>
                        @endforeach
                            <tr>
                                ...
                                <td><input type="checkbox" name="parttime[]" /></td>
                            </tr>
                        </tbody>
                    </table>
                    <!-- /.box-body -->
