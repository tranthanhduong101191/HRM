                ...
                <form class="form-horizontal" method="post">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control" value="{{$data->uid}}" name="uid"/>
                            </div>

                            <label class="col-sm-2 control-label">Lương cứng</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="luongcung" placeholder="Lương cứng" autocomplete="off" value="{{old('luongcung', currency_format($data->luongcung))}}" />
                            </div>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control datepicker" name="birthday" placeholder="Ngày sinh" autocomplete="off" value="{{\Carbon\Carbon::parse($data->birthday)->format('dd/mm/YYYY')}}" />
                            </div>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="cmnd" placeholder="CMND" value="{{old('cmnd', $data->cmnd)}}"/>
                            </div>

                            <label class="col-sm-2 control-label">Địa chỉ</label>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="address" placeholder="Địa chỉ" value="{{old('address', $data->address)}}"/>
                            </div>
                        </div>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                @foreach(\App\Group::get() as $gr)
                                        <option value="{{$gr->id}}" @if( old('group_id', \App\User::find(request('id'))->group_id)==$gr->id) selected @endif>{{$gr->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <select class="form-control" name="branch_id">
                                    @foreach(\App\Branch::get() as $br)
                                        <option value="{{$br->id}}" @if( old('branch_id', \App\User::find(request('id'))->branch_id)==$br->id) selected @endif>{{$br->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <div class="col-sm-6">
                                <input type="checkbox" name="parttime" value="1" @if(old('parttime', $data->parttime) == 1) checked @endif /> Nhân viên bán thời gian
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
