        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">{{trans('page.editgroup')}}</h3>
                ...
                <form class="form-horizontal" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Công chuẩn</label>

                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="congchuan" placeholder="Nhập công chuẩn" value="{{old('congchuan', !empty($data->congchuan)?$data->congchuan:'')}}">
                            </div>
                        </div>
